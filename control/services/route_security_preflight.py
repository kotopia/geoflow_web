...
ROUTE_SECURITY_BOUNDARIES = (
    ...
    (f"/contracts/{_UUID}/document-requests/panel/", "tenant:contract_document_request_panel", "geoflow_ops.contract_access_views", "contract_document_request_panel"),
    (f"/contracts/document-requests/{_UUID}/decide/", "tenant:contract_document_request_decide", "geoflow_ops.contract_access_views", "contract_document_request_decide"),
    ("/api/contracts/workflow-states/", "tenant:contract_workflow_states", "geoflow_ops.workflow_state_views", "contract_states"),
    (f"/api/contracts/{_UUID}/workflow-state/", "tenant:contract_workflow_state", "geoflow_ops.workflow_state_views", "contract_state"),
    ...
    (f"/projects/{_UUID}/contract-documents/panel/", "tenant:project_contract_document_panel", "geoflow_ops.contract_access_views", "project_contract_document_panel"),
    (f"/projects/{_UUID}/contract-documents/request/", "tenant:project_contract_document_request", "geoflow_ops.contract_access_views", "project_contract_document_request"),
    ...
    (f"/api/projects/{_UUID}/execution-state/", "tenant:project_execution_state", "geoflow_ops.workflow_state_views", "project_execution_state"),
    ...
    ("/settings/department/save/", "tenant:settings_department_save", "geoflow_ops.settings_security_views", "settings_department_save"),
