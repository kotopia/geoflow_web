...
ROUTE_SECURITY_BOUNDARIES = (
    ...
    ("/bids/", "tenant:bid_notice_list", "geoflow_ops.bids.security_views", "notice_list"),
    ("/bids/settings/", "tenant:bid_settings", "geoflow_ops.bids.security_views", "settings_page"),
    ("/bids/settings/filter/save/", "tenant:bid_filter_save", "geoflow_ops.bids.security_views", "filter_value_save"),
    ("/bids/settings/keyword/save/", "tenant:bid_keyword_save", "geoflow_ops.bids.security_views", "keyword_save"),
    (f"/bids/{_UUID}/review/", "tenant:bid_review_save", "geoflow_ops.bids.security_views", "review_save"),
    ("/bids/sync/", "tenant:bid_sync", "geoflow_ops.bids.security_views", "sync_now"),
    ...
    (f"/finance/accounts/{_UUID}/delete/", "tenant:finance_account_delete", "geoflow_ops.finance_security_views", "account_delete"),
    ("/finance/cards/save/", "tenant:finance_card_save", "geoflow_ops.finance_security_views", "card_save"),
    (f"/finance/cards/{_UUID}/delete/", "tenant:finance_card_delete", "geoflow_ops.finance_security_views", "card_delete"),
