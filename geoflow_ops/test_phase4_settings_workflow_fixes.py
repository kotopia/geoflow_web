...
class Phase4SettingsWorkflowFixesTests(unittest.TestCase):
    ...
    def test_contract_kind_and_event_vocabularies_remain_tenant_settings_driven(self):
        ...
        migration = source("geoflow_ops/migrations/0029_unified_settings_registry.py")
        detail = source("geoflow_ops/templates/geoflow_ops/contracts/contract_detail.html")
        ...
        for key in (
            "contract.kind", "event.stage", "event.type",
            "employee.position_grade", "employee.position_title",
        ):
        ...
        self.assertIn("root.field_ref = 'event.type'", service)
        self.assertNotIn("SYSTEM_REQUIRED_OPTIONS", service)
        self.assertNotIn("CONTRACT_KIND_FALLBACK", service)
