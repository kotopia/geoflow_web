...
class QFieldSyncConcurrencyContractTests(SimpleTestCase):
    ...
    def test_qfield_sidecar_combines_roaming_offline_sync_and_plan_layer_binding(self):
        ...
        self.assertIn("function syncNow(manual, acceptedEdit)", text)
        ...
        self.assertIn("editCommandEnded.connect", text)
        self.assertIn("afterCommitChanges.connect", text)
        ...
        self.assertIn("GeoFlow Field 0.9", text)
