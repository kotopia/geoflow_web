...
class ResolutionTests(unittest.TestCase):
    ...
    def test_qgis_flow_dip_repair_and_logging_contract(self):
        ...
        self.assertIn('_django_tenant_alias', repair)
        self.assertIn('connections.databases[alias]=db_config', repair)
        self.assertIn('GeoPackage metadata에 flow_dip 문자열이 남아 있습니다.', repair)
        self.assertIn('production_release_service_recovered_after_schema_failure=yes', deploy)
