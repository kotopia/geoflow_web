...
class TenantRouteAuthorizationContractTests(unittest.TestCase):
    def test_sensitive_tenant_routes_stay_on_guarded_handlers(self):
        ...
        expected = {
            ...
            "contracts/<uuid:pk>/document-requests/panel/": "contract_access_views.contract_document_request_panel",
            "contracts/document-requests/<uuid:request_id>/decide/": "contract_access_views.contract_document_request_decide",
            "api/contracts/workflow-states/": "workflow_state_views.contract_states",
            "api/contracts/<uuid:pk>/workflow-state/": "workflow_state_views.contract_state",
            ...
            "projects/<uuid:pk>/members/": "security_views.project_members_panel",
            "projects/<uuid:pk>/members/save/": "security_views.project_member_save",
            "projects/<uuid:pk>/members/<uuid:member_id>/revoke/": "security_views.project_member_revoke",
            "projects/<uuid:pk>/contract-documents/panel/": "contract_access_views.project_contract_document_panel",
            "projects/<uuid:pk>/contract-documents/request/": "contract_access_views.project_contract_document_request",
            ...
            "api/projects/mine/": "security_views.my_projects_api",
            "api/projects/<uuid:pk>/access/": "security_views.project_access_api",
            "api/projects/<uuid:pk>/execution-state/": "workflow_state_views.project_execution_state",
            ...
            "settings/": "settings_security_views.settings_page",
            "settings/node/save/": "settings_security_views.settings_node_save",
            "settings/department/save/": "settings_security_views.settings_department_save",
